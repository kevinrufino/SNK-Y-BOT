            ...
            try {
                ...
                if (this.firstRun) {
                    ...
                    products.forEach(x => {
                        ...
                        // console.log("NewProducts:::", newProducts) //list products that matches keywords
                    });
                    ...
                    Seller.findById(this.sellerId, async (err, sellerQuery) => {
                        if (err) {
                            ...
                            // console.log("OLD PRODUCTS", oldProducts) //this is the seller queried products?
                            var newProducts = []

                            if (this.keywords.length > 0) {
                                products = this.productsToCheck(products)
                                // console.log("item is sent to productsToCheck and returns...")
                            ...
                            await products.forEach(async product => {
                                ...
                                if (found) {
                                    ...
                                    // console.log("NEWPR:::(before updateInformation)", newPr)
                                    newPr.updateInformation(product);
                                    // console.log("NEWPR:::(after updateInformation)", newPr)

                                    //what is this and why was it set to true before?
